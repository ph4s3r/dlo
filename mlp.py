# -*- coding: utf-8 -*-
"""
Created on Fri Oct 11 11:45:02 2019

@author: karapet
"""
#neuralnet = MLP(2,2,10,10,1)
# XOR1
# x1 x2 y
# 0 0 0
# 0 1 1 
...
class MLP:
    ...
    def propagate_forward(self, data):
        self.layers[0][0:-1] = data #bias marad 1
    ...
    def propagate_backward(self, target, lrate=0.1, momentum=0.1):
        deltas = []
        error = -(target-self.layers[-1]) # y -y kalap 
